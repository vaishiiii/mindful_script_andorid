...
export const QUOTES = {
  calm: [
    ...
    "A calm mind sees options that a rushed mind misses.",
    "Peace is a practice, not a personality trait.",
    "Take one slower breath and the room changes with you.",
    "Softness is not weakness. It is controlled strength.",
    "Calm is how you protect your energy for what matters.",
    "You do not need to speed up to make progress.",
    "When you return to your breath, you return to yourself.",
    "Silence can be a strategy, not an escape.",
    "Choose steady over dramatic. Steady wins.",
    "A regulated nervous system is a competitive advantage.",
    "Ease is not laziness. Ease is intelligent effort.",
    "You can be calm and still be powerful.",
    "Today, protect your peace before you protect your pace.",
    "Composure is built in tiny moments of restraint.",
  ...
  focus: [
    ...
    "Depth creates results that speed cannot.",
    "Your priorities are revealed by your calendar, not your intentions.",
    "Protect your focus like it is your most valuable asset, because it is.",
    "Distraction is expensive. Presence is profitable.",
    "Finish the next right task before chasing the next new one.",
    "Concentration is a skill you train, not a mood you wait for.",
    "Attention is leadership over your own mind.",
    "Simplicity is focus in visible form.",
    "You get momentum by reducing options, not adding more.",
    "What gets scheduled gets completed.",
    "Quiet your inputs to amplify your output.",
    "Focus is saying no to noise with confidence.",
    "Great work is usually made in uninterrupted hours.",
    "One clear hour can change an entire day.",
    "The next best move is enough. Do it now.",
  ],
  confidence: [
    ...
    "Courage grows each time you keep a promise to yourself.",
    "Your voice gets stronger every time you use it.",
    "Confidence is evidence collected through action.",
    "Progress is proof that you can trust yourself.",
    "You do not need perfect certainty to take the next step.",
    "Self-belief is a daily vote, not a one-time decision.",
    "Start before you feel ready. Readiness follows motion.",
    "You become credible to yourself by following through.",
    "Strength is built by doing hard things calmly.",
    "Each rep of courage changes your identity.",
    "You are more capable than your doubt suggests.",
    "Your future confidence is funded by today's action.",
    "Take the lead in your own life, one decision at a time.",
    "Stand by your values and your confidence will rise.",
    "The win is showing up as the person you respect.",
  ],
  healing: [
    ...
    "Kindness toward yourself is part of the treatment.",
    "Some days the work is simply staying open.",
    "Recovery can be quiet and still be profound.",
    "You are not behind. You are rebuilding with wisdom.",
    "Give your nervous system permission to feel safe again.",
    "Small honest steps can repair deep pain.",
    "What you face with compassion begins to soften.",
    "You do not need to perform healing. You only need to live it.",
    "Rest can be a courageous decision.",
    "The body remembers safety when you practice it daily.",
    "Release pressure. Keep direction.",
    "Your pace is valid. Your process is valid.",
    "Healing is growth with tenderness.",
  ],
  discipline: [
    ...
    "Consistency beats intensity when measured over months.",
    "Your routine is your results in advance.",
    "Discipline is self-respect in repeated form.",
    "Do the basic things well, every day.",
    "Structure creates freedom.",
    "You are one completed promise away from momentum.",
    "Standards, not mood, should run your day.",
    "Hard days are where identity is forged.",
    "Keep the streak of effort, even when outcomes are slow.",
    "Reliable actions create remarkable outcomes.",
    "Your calendar is your discipline scorecard.",
    "The boring reps are the breakthrough reps.",
    "Do not negotiate with the task. Begin.",
    "Be strict with process and patient with results.",
    "When you honor the plan, you honor your future.",
  ],
  purpose: [
    ...
    "Meaning grows where contribution and values meet.",
    "Direction reduces noise.",
    "You do not need a perfect map to take a meaningful step.",
    "Purpose turns effort into significance.",
    "Act in alignment and your path gets clearer.",
    "A clear why can carry you through a hard how.",
    "Let today's choices match the life you want to describe.",
    "Intention gives your schedule a soul.",
    "Your purpose is practiced, not announced.",
    "What matters most deserves your best hours.",
    "Build a life you are proud to report back to yourself.",
    "Your next aligned action is enough for today.",
    "Meaning is momentum with direction.",
    "A purpose-led day feels different before it looks different.",
    "Use your energy where your values live.",
  ],
  habit: [
    ...
    "Your identity is shaped by what you repeat.",
    "Tiny wins, stacked daily, become life changes.",
    "Make the good action obvious and easy.",
    "Automation starts with intentional repetition.",
    "Habits are decisions you no longer have to negotiate.",
    "Your future self lives inside your routine.",
    "Lower friction for the behavior you want to keep.",
    "The first two minutes decide the next two years.",
    "Build cues that trigger the person you want to become.",
    "Sustainable change is simple, repeated, and protected.",
    "Do less, but do it daily.",
    "Reliable habits make motivation optional.",
    "A better default creates a better day.",
    "Your system should carry you on low-energy days.",
    "Repetition with awareness becomes mastery.",
  ],
};
