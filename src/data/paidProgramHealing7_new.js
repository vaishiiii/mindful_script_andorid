...
const paidProgramHealing7 = [
  {
    ...
    morning: {
      ...
      steps: [
        ...
        "Write its name on paper (just one word)",
    ...
    midday: {
      ...
      steps: [
        ...
        "Notice how your body feels when your environment is ordered",
      ],
      timer: 300,
    },
    night: {
      ...
      steps: [
        ...
        "Did I allow myself to feel today?",
        "What emotion showed up most?",
        "Did I resist or allow it?",
        "What did I learn?",
      ],
    },
  },
